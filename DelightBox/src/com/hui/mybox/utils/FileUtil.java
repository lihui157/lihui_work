...
public class FileUtil {
	...
	public static  void copyFolder(String oldPath, String newPath) {
		...
		try {
			...
			LogUtil.debug(TAG,"复制整个文件夹内容操作出错");
			e.printStackTrace();
