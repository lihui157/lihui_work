...
public class NativeImageLoader {
	 ...
	 * @return
	 */
	private Bitmap decodeThumbBitmapForFile(final String path, final int viewWidth, final int viewHeight) {
		...
		try {
			return BitmapFactory.decodeStream(new FileInputStream(new File(path)), null,options);
	 ...
	 * @param height
	 */
	private int computeScale(final BitmapFactory.Options options, final int viewWidth, final int viewHeight) {
		int inSampleSize = 1;
