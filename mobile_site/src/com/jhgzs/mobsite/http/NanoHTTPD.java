...
//                        	String tmpdir = Environment.getExternalStorageDirectory().getAbsolutePath()+"/webroot";
                                try {
                                        ...
                                        LogUtil.debug("", "saveTmpFile", "path "+path);
                                                           ...
                                                           boolean allowDirectoryListing )
        {
                ...
                if ( res == null && f.isDirectory())
                {
                        ...
                        if ( res == null )
                        {
                                ...
                                if ( new File( f, "/webroot/index.html" ).exists())
                                        f = new File( homeDir, uri + "/webroot/index.html" );
                                else if ( new File( f, "/webroot/index.htm" ).exists())
                                        f = new File( homeDir, uri + "/webroot/index.htm" );
